# Generated by Django 5.1.1 on 2024-11-16 02:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField(choices=[('', '選択してください'), (datetime.time(2, 30), '2:30'), (datetime.time(3, 0), '3:00'), (datetime.time(3, 30), '3:30'), (datetime.time(4, 0), '4:00'), (datetime.time(4, 30), '4:30'), (datetime.time(5, 0), '5:00'), (datetime.time(5, 30), '5:30'), (datetime.time(6, 0), '6:00'), (datetime.time(6, 30), '6:30'), (datetime.time(7, 0), '7:00'), (datetime.time(7, 30), '7:30'), (datetime.time(8, 0), '8:00'), (datetime.time(8, 30), '8:30'), (datetime.time(9, 0), '9:00'), (datetime.time(9, 30), '9:30'), (datetime.time(10, 0), '10:00'), (datetime.time(10, 30), '10:30')], default='', verbose_name='時間')),
